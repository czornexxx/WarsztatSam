...
CREATE TABLE `czesci` (
  `idCzesci` int(11) NOT NULL AUTO_INCREMENT,
  `Model` varchar(45) DEFAULT NULL,
  `Cena` float DEFAULT NULL,
  `Firma` varchar(45) DEFAULT NULL,
  `Nazwa` varchar(45) DEFAULT NULL,
  `StanMagazynowy` int(11) DEFAULT NULL,
...
INSERT INTO `czesci` VALUES (1,'as',22,'as','a',2),(2,'2',2,'2','2',2),(3,'3',4,'52','2',4),(4,'F232',20,'Filtron','Filtr oleju Stilo',20),(5,'Fi 223-234',20,'Bosh','Filtr oleju Stilo',30),(6,'FP222',20,'Bosh','Filtr Powietrza',20);
